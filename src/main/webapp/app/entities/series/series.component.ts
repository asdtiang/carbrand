...
export class SeriesComponent implements OnInit, OnDestroy {
  ...
  registerChangeInSeries() {
    this.eventSubscriber = this.eventManager.subscribe('seriesListModification', () => this.loadAll());
  }

  delete(series: ISeries) {
  ...
  protected paginateSeries(data: ISeries[], headers: HttpHeaders) {
