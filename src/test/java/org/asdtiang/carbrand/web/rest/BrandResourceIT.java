...
public class BrandResourceIT {
    ...
    public void createBrand() throws Exception {
        ...
        assertThat(testBrand.getFirstLetter()).isEqualTo(DEFAULT_FIRST_LETTER);
        assertThat(testBrand.getImg()).isEqualTo(DEFAULT_IMG);
    }
    ...
    @Test
    @Transactional
    public void checkFirstLetterIsRequired() throws Exception {
        int databaseSizeBeforeTest = brandRepository.findAll().size();
        // set the field null
    ...
    public void updateBrand() throws Exception {
        ...
        assertThat(testBrand.getFirstLetter()).isEqualTo(UPDATED_FIRST_LETTER);
        assertThat(testBrand.getImg()).isEqualTo(UPDATED_IMG);
    }
