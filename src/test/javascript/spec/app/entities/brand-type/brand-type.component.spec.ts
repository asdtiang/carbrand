...
import { BrandTypeComponent } from 'app/entities/brand-type/brand-type.component';
...
describe('Component Tests', () => {
  describe('BrandType Management Component', () => {
    let comp: BrandTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BrandTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.brandTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
