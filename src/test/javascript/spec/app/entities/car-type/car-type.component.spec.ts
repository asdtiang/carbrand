...
import { CarTypeComponent } from 'app/entities/car-type/car-type.component';
  ...
  describe('CarType Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CarTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.carTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
